...
button4.id = "china";
btnContainer.appendChild(button4);

const menuDiv = document.querySelector(".section-center")

const allButton = document.querySelector("#all")
allButton.addEventListener("click", showMenuAll);
const koreaButton = document.querySelector("#korea")
koreaButton.addEventListener("click", showMenuKorea);
const japanButton = document.querySelector("#japan")
japanButton.addEventListener("click", showMenuJapan);
const chinaButton = document.querySelector("#china")
chinaButton.addEventListener("click", showMenuChina);
